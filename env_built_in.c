...
/**
 * _getenv - gets PATH member from environment
 * @name: pointer to the PATH string
 *
 * Return: pointer to the PATH member string or NULL if not found
 */
...
/**
 * _memset - fills memory with a constant role
